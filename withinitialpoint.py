...
if __name__ == '__main__':
    ...
    def train_step(input, portions):
        ...
        with tf.GradientTape() as tape:
            ...
            Sigma_time_delay_zf = loss.tf_sigma_delay_square(steering_vector_this_o,
                                                             tf.transpose(zf_matrix, perm=[0, 2, 1]), beta)
            # Sigma_time_delay_zf = loss.tf_sigma_delay_square(steering_vector_this_o,
            #                                              zf_matrix, beta)
            ...
            combined_loss = tf.reduce_sum(portions[1] * CRB_d + portions[2] * CRB_angle - portions[0] * sum_rate_this,
                                          axis=0) / batch_size
    ...
    input_whole = loss.Conversion2input_small3(angle, distance)
    ...
    for iter in range(0, config_parameter.iters):
        ...
        for batch in tf_dataset:
            ...
            input_single = batch
            communication_loss, output, CSI, gradients, crb_d, crb_angle, combined_loss = train_step(input_single,
                                                                                                     portions)

            print("Epoch: {}/{},losscomm: {},loss_d:{},loss_angle:{},loss_combined_loss:{}".format(iter + 1,
