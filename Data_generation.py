...
angles_1 = np.random.uniform(0.15*np.pi, 0.3*np.pi, size=(num_samples, 1))
angles_2 = np.random.uniform(0.3*np.pi, 0.45*np.pi, size=(num_samples, 1))
angles_3 = np.random.uniform(0.55*np.pi, 0.7*np.pi, size=(num_samples, 1))
angles_4 = np.random.uniform(0.7*np.pi, 0.85*np.pi, size=(num_samples, 1))
