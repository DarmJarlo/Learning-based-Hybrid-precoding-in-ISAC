...
def comparison_between_crb_distance(combined):
    ...
    ax1.plot(range(10), CRB_d1, 'b-.', label='hybrid ISAC')

    ax1.plot(range(10), CRB_d2, 'g-', label='digital ISAC,with initial point')
    ax1.plot(range(10), CRB_d3, 'r.-', label='digital ISAC,without initial point')
    ax1.plot(range(10), CRB_d4, 'm.', label='hybrid only crb_distance')
    ax1.plot(range(10), CRB_d5, 'r-', label='digital with initial point only crb_distance')
    ax1.plot(range(10), CRB_d6, 'b-', label='digital without initial point only crb_distance')
    ax1.plot(range(10), CRB_d7, 'g.', label='ZF precoder')
    ax1.set_xlabel('time')
